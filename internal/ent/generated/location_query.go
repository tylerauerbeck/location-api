...
func (lq *LocationQuery) FirstID(ctx context.Context) (id gidx.PrefixedID, err error) {
...
func (lq *LocationQuery) FirstIDX(ctx context.Context) gidx.PrefixedID {
...
func (lq *LocationQuery) OnlyID(ctx context.Context) (id gidx.PrefixedID, err error) {
	var ids []gidx.PrefixedID
...
func (lq *LocationQuery) OnlyIDX(ctx context.Context) gidx.PrefixedID {
...
func (lq *LocationQuery) IDs(ctx context.Context) (ids []gidx.PrefixedID, err error) {
...
func (lq *LocationQuery) IDsX(ctx context.Context) []gidx.PrefixedID {
	ids, err := lq.IDs(ctx)
	if err != nil {
		panic(err)
	}
