...
import (
	...
	dbm "go.infratographer.com/location-api/db"
	"go.infratographer.com/location-api/internal/config"
)

const appName = "location-api"
...
var rootCmd = &cobra.Command{
	Use:   appName,
	Short: "A utility for managing location definitions",
	Long:  `location-api is a service for managing locations`,
}
...
func initConfig() {
	...
	viper.SetEnvPrefix("locationapi")
